...
class Gcode_tools(inkex.Effect):
    ...
    def __init__(self):
        ...
        self.OptionParser.add_option("-z", "--Zoffset",                    action="store", type="float",         dest="Zoffset", default="0.0",                    help="Offset along Z")    
...
#            p = np[:]        
    ...
    def effect(self):
        ...
        logger.write("page height == %d" % self.pageHeight)
